...
const translations = {
  tr: {
    ...
    'bio.p1': '4 yıllık deneyimimle modern web teknolojileri konusunda uzmanlaşmış bir yazılım mühendisiyim. Kullanıcı deneyimini ön planda tutarak, performanslı ve ölçeklenebilir uygulamalar geliştiriyorum.',
  ...
  en: {
    ...
    'bio.p1': 'I am a software engineer with 4 years of experience specialized in modern web technologies. I develop performant and scalable applications with a focus on user experience.',

      ...
      <div className="flex-grow pt-24 pb-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16">
            <h1 className="inline-block text-4xl sm:text-5xl font-bold text-gray-900 dark:text-white mb-6 typewriter">
              {t('hero.greeting')}
            </h1>
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto typewriter delay-1">
              {t('hero.title')}
            </p>
          </div>
